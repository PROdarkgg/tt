...
client.on('message', message => {
  ...
  if (message.author.id !== "241554153023864832") return;
...
if (message.content.startsWith(prefix + 'setT')) {
  client.user.setGame(argresult, "https://www.twitch.tv/special2");
     console.log('test' + argresult);
...
client.on("message", message => {
    if (message.content === (prefix + "help")) {
     const embed = new Discord.RichEmbed() 
         ...
         .setDescription(`**
         ------------------------------
         s!bc1 : برودكاست لجميع اعضاء السيرفر بايمبد
         s!bc2 : برودكاست لجميع اعضاء السيرفر بدون ايمبد
         s!bc3 : برودكاست للاعضاء  الاونلاين فقط
         ------------------------------
         s!id : عرض ملفك الشخصي
         s!ask :البوت يسئلك اسئلة
         s!server : احصائيات السيرفر
         ------------------------------
         s!ban : حظر العضو من السيرفر
         s!kick : طرد العضو من السيرفر
         s!clear : مسح الشات
         s!createroles : عمل رتب متكاملة للسيرفر
         s!voicesetup : انشاء روم فويس اونلاين
         لكتابة الكلام الذي في الروم اكتب _voicesetup الكلام و 0 
         ------------------------------
         s!guilds : عدد سيرفر البوت
         s!help : عرض هذه الرسالة
         ------------------------------
...
client.login('NTk4MDk3MTc2Mjk5NTY5MTYy.XSV8Zw.08efM0sowllNat5MDehmu_vMctM');